...
import { CrudSearch, CrudSelect } from "../../components/crud";
...
export function SessionToolbar({
  ...
  onSort: (
    sort: SessionFiltersState["sort"],
    order: SessionFiltersState["order"],
  ) => void;
      ...
      <YStack gap="$3">
        ...
        >
          ...
          <CrudSelect
            ...
            label="Status"
            onChange={(value) =>
              onStatus(value as SessionFiltersState["status"])
            }
          ...
          <CrudSelect
            ...
            onChange={(value) => {
              ...
              onSort(
                sort as SessionFiltersState["sort"],
                order as SessionFiltersState["order"],
              );
            }}
            options={sortOptions}
            value={selectedSort}
