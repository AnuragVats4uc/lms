...
function SessionModal({
  ...
  return (
    <AppModal
      ...
      description="Save session details and refresh the current organization list."
      footer={
        <>
          <Button
            background="#FFFFFF"
...
export function AddSessionModal(
  props: Omit<
    Parameters<typeof SessionModal>[0],
    "formId" | "submitLabel" | "title"
  >,
) {
  return (
    <SessionModal
      {...props}
      formId="session-add-form"
